...
const Layout: React.FC<LayoutProps> = () => {
  ...
  const toggleDriverMode = () => {
    // Add your logic to toggle driver mode here
    console.log("Driver mode toggled");
  };
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      <Drawer>
        ...
        />
        <Drawer.Screen
          name="settingHelpSupport" // This is the name of the page and must match the URL from root
          options={{
            drawerLabel: "Setting Help Support",
            title: "Setting Help Support",
          }}
        />
